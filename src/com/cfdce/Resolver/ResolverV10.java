...
public class ResolverV10 {
	...
	public static void main(String[] args)
		...
		PrintWriter fToSave = new PrintWriter(new FileWriter("logs/centralSolutionResultsBasic_"+indSimulation+".txt"));
...
for(int con = indPlans; con<14; con++){
...
System.out.println(" -> The End ....! with effeciency : "+sysEffeciency);
	}
