...
public class ResolverV10WithoutComment {
	...
	public static void main(String[] args)
		...
		listeAgent.add(agentTab);
		agentTab= new int[] {11,11,11};
		listeAgent.add(agentTab);
		agentTab= new int[] {12,12,12};
		listeAgent.add(agentTab);
		agentTab= new int[] {13,13,13};
		listeAgent.add(agentTab);
		agentTab= new int[] {14,14,14};
		listeAgent.add(agentTab);
		agentTab= new int[] {15,15,15};
		listeAgent.add(agentTab);
		agentTab= new int[] {16,16,16};
		listeAgent.add(agentTab);
		agentTab= new int[] {17,17,17};
		listeAgent.add(agentTab);
		agentTab= new int[] {18,18,18};
		listeAgent.add(agentTab);
		agentTab= new int[] {19,19,19};
		listeAgent.add(agentTab);
		agentTab= new int[] {20,20,20};
		listeAgent.add(agentTab);
		agentTab= new int[] {21,21,21};
		listeAgent.add(agentTab);
		agentTab= new int[] {22,22,22};
		listeAgent.add(agentTab);
		agentTab= new int[] {23,23,23};
		listeAgent.add(agentTab);
		agentTab= new int[] {24,24,24};
		listeAgent.add(agentTab);
		agentTab= new int[] {25,25,25};
		listeAgent.add(agentTab);
		agentTab= new int[] {26,26,26};
		listeAgent.add(agentTab);
		agentTab= new int[] {27,27,27};
		listeAgent.add(agentTab);
		agentTab= new int[] {28,28,28};
		listeAgent.add(agentTab);
		agentTab= new int[] {29,29,29};
		listeAgent.add(agentTab);
