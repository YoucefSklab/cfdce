...
public class PartitionSetCreatorOld<T> {
    ...
    public static void main(String[] args) {
        ...
        PartitionSetCreatorOld<Integer> partSetCreatorEmpty = new PartitionSetCreatorOld<Integer>(baseSet);
        ...
        baseSet.add(1);
        PartitionSetCreatorOld<Integer> partSetCreator = new PartitionSetCreatorOld<Integer>(baseSet);
        ...
        baseSet.add(2);
        PartitionSetCreatorOld<Integer> partSetCreator2 = new PartitionSetCreatorOld<Integer>(baseSet);
        ...
        baseSet.add(3);
        PartitionSetCreatorOld<Integer> partSetCreator3 = new PartitionSetCreatorOld<Integer>(baseSet);
        ...
        baseSet.add(4);
        PartitionSetCreatorOld<Integer> partSetCreator4 = new PartitionSetCreatorOld<Integer>(baseSet);
    ...
    public PartitionSetCreatorOld(Set<T> base) {
        this.base = base;
