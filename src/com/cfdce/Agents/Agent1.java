...
public class Agent1 extends Agent {
	...
	//	public Hashtable discussionsProbability=new Hashtable(); 
		...
		private int maxRound = 3;  // nombre max de round � ex�cuter 
		...
		private int mainWaitingTime = 9000; //9000
		private int roundWaitingTime = 1000; //1000
		private int timeToWait = roundWaitingTime;
		private int sendProposalsWaitingTime = 9*roundWaitingTime; 
		...
		private int timeWaitUpdateAgentsRelatedData = 1000; //3000
		private int confirmationWaitingTime = 2000; //3000        // cette valeur doit aussi �tre en fonction de roundWaitingTime
		private int totalTimeIncrementationValue = 300;
		public static long allProcessNeededTime = 40000; // 50000
